...
export def Lines(): list<string>
  ...
  var lines = [
    ...
    '',
    Heading('group_toggle', 'Interface'),
    printf('  [%s] %-14s %s',
  ...
  lines->extend(['', Heading('group_code', 'Plugins')])
  if exists('g:plugs')
...
export def Show(): void
  window.Scratch('[chopsticks-health]', Lines(), 'chopsticks-health')
enddef
